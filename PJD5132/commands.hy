...
(setv *commands*
  '((power-on                     nil       (0x06  0x14 0x00  0x04  0x00 0x34 0x11 0x00 0x00 0x5D))
    ...
    (splash-screen-status         nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x0A 0x68)) 
    ...
    (quick-power-off-status       nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x0B 0x69))
    ...
    (high-altitude-status         nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x0C 0x6A))
    ...
    (lamp-mode-status             nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x10 0x6E))
    ...
    (message-status               nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x27 0x85))
    ...
    (position-status              nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x00 0x5F))
    ...
    (brightness-status            nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x03 0x62))
    ...
    (aspect-ratio-status          nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x04 0x63))
    ...
    (horizontal-position-status   nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x06 0x65))
    ...
    (vertical-position-status     nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x07 0x66))
    ...
    (blank-status                 nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x09 0x68))
    ...
    (keystone-status              nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x0A 0x69))
    ...
    (color-mode-preset-mode-statu nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x0B 0x6A))
    ...
    (primary-color-status         nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x10 0x6F))
    ...
    (hue                          nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x11 0x70))
    ...
    (saturation                   nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x12 0x71))
    ...
    (gain                         nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x12 0x13 0x72))
    ...
    (freeze-status                nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x13 0x00 0x60))
    ...
    (input-source                 nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x13 0x01 0x61))
    ...
    (quick-auto-search-status     nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x13 0x02 0x62))
    ...
    (hdmi-format                  nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x28 0x86))
    ...
    (hdmi-range-status            nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x11 0x29 0x87))
    (mute                         nil       (0x06  0x14 0x00  0x04  0x00 0x34 0x14 0x00 0x01 0x61))
    (unmute                       nil       (0x06  0x14 0x00  0x04  0x00 0x34 0x14 0x00 0x00 0x60))
    (mute-status                  nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x14 0x00 0x61))
    ...
    (volume                       nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x14 0x03 0x64))
    (lamp-usage-reset             nil       (0x06  0x14 0x00  0x04  0x00 0x34 0x15 0x01 0x00 0x62))
    (lamp-usage-hours             nil       (0x07  0x14 0x00  0x05  0x00 0x34 0x00 0x00 0x15 0x01 0x63))
